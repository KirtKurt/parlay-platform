...
4. At the next 02:00 Eastern run, completed games with original KS1 lock evidence
...
The hourly cron is at minute 17. DST and the 02:00 Eastern delayed-run catch-up
...
The nightly gate is 02:00 America/New_York. The existing hourly runner
