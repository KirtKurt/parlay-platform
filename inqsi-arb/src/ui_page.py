    ...
    <div>
      <div class="panel">
        <div class="controls">
          ...
          <div><label>Jurisdiction</label><select id="jurisdiction"><option value="*">Unscoped</option><option value="ny">New York</option><option value="in">Indiana</option></select></div>
