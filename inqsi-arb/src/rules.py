...
# Reviewed seed rules are deliberately narrow. They establish only combinations
# whose ordinary-settlement semantics were checked against current official book
# rules. Everything else remains UNKNOWN until separately reviewed.
