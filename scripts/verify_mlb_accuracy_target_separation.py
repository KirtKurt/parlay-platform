...
def main() -> int:
    ...
    assert installed.get("minimumOutcomeUntouchedAccuracyPct") == 90.0
    ...
    assert os.environ.get("INQSI_MLB_ML_MIN_OUTCOME_UNTOUCHED_ACCURACY") == "90.0"
    ...
    assert runtime_safety.MIN_ROLLING_24H_SLATE_ACCURACY_PCT == 90.0
    assert champion.MIN_OUTCOME_UNTOUCHED_ACCURACY_PCT == 90.0
    ...
    assert champion.MIN_ROLLING_24H_SLATE_ACCURACY_PCT == 90.0
