...
required_template_strings = {
    ...
    "MLB_ML_EXPERIMENT_ID: 'mlb-v2-2026-07-29-future-prospective-r5'": 'AWS-native MLB ML trainer experiment identity is stale',
    "MLB_ML_RELEASE_CONTRACT_ID: 'mlb-v2-2026-07-29-future-prospective-r5'": 'AWS-native MLB ML trainer release contract is stale',
    "MLB_ML_RELEASE_CUTOFF_UTC: '2026-07-29T04:00:00+00:00'": 'AWS-native MLB ML trainer release cutoff is stale',
