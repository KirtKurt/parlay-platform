...
required_template_strings = {
    ...
    'MLBMLSelectionCaptureEvery2Minutes': 'AWS-native MLB ML selection capture schedule missing',
    ...
    "MLB_ML_EXPERIMENT_ID: 'mlb-v2-2026-08-31-historical-live-r8'": 'AWS-native MLB ML trainer experiment identity is stale',
    "MLB_ML_RELEASE_CONTRACT_ID: 'mlb-v2-2026-08-31-historical-live-r8'": 'AWS-native MLB ML trainer release contract is stale',
    "MLB_ML_RELEASE_CUTOFF_UTC: '2026-08-31T04:00:00+00:00'": 'AWS-native MLB ML trainer release cutoff is stale',
    ...
    'Schedule: cron(1/2 * * * ? *)': 'AWS-native MLB ML selection capture is not staggered every 2 minutes',
