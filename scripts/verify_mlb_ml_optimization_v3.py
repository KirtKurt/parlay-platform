...
R4_EXPERIMENT_ID = "mlb-v2-2026-08-03-future-prospective-r7"
R4_RELEASE_CUTOFF_UTC = "2026-08-03T04:00:00+00:00"
...
def main() -> int:
    ...
    print(
        ...
        "remain non-authoritative; production proof is r3 future-cutover fixed whole-slate "
