"""Connect every MLB 15-minute Odds API pull to stored line-movement predictions."""
...
def _store_combo(date_api: Any, game_date: str, prediction_result: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if table is None:
        return {"ok": False, "stored": False, "reason": "PREDICTIONS_TABLE not configured"}
