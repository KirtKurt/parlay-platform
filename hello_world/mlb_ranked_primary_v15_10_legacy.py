"""Verified legacy loader retained only for pre-cutover compatibility and audit.

The historical production selector delegates here only while no write-once
historical cutover record exists. After cutover, this module is never permitted
to select or restore a production winner.
"""
...
exec(compile(_source, str(_RESOURCE) + "::<verified-legacy-source>", "exec"), globals(), globals())
