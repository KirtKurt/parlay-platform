...
def handle_health() -> Dict[str, Any]:
    return resp(200, {
        ...
        "creatorAnalyticsDashboardDelegated": creator_analytics is not None,
        ...
        "liveEndpoints": [
            ...
            "/v1/inqsi/admin/analytics/creators",
...
def route(event: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    if creator_analytics is not None:
        creator_routed = creator_analytics.route(event)
        if creator_routed is not None:
            return creator_routed
