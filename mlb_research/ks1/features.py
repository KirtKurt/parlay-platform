...
class Features:
    ...
    def lineup_batters_at(self, cutoff, lineup_ids, opposing_starter_id=None,
        ...
        # The arsenal includes relief pitches too. Require independent proof
        # for every official pitching appearance, even when Statcast has no
        # rows (or the official BF/start fields are zero or incomplete).
        official_pitcher_game_ids = {
        ...
        starter_game_ids = official_pitcher_game_ids | {
