...
def binding(model_digest="model-one"):
    return {
        ...
        "SK": "REV#4#HORIZON#T45#TARGET#result_1x2",
        ...
        "horizon": "T45",
        "target": "result_1x2",
        "lock_sk": "LOCK#T45#REV#4#TARGET#result_1x2",
        ...
        "bound_at": "2026-08-14T13:20:00Z",
        "publication_cutoff": "2026-08-14T13:50:00Z",
        "commit_deadline": "2026-08-14T13:49:50Z",
        "commit_headroom_seconds": 10,
        "autonomy_updated_at": "2026-08-14T13:19:00Z",
        "autonomy_updated_at_epoch_ms": 1_786_713_540_000,
...
def prediction(model_digest="model-one"):
    return {
        ...
        "SK": f"PRED#T45#REV#4#TARGET#result_1x2#MODEL#{model_digest}",
...
class AtomicPublicPredictionTests(unittest.TestCase):
    def setUp(self):
        ...
        self.store.ops.rows[("AUTONOMY", "STATE")] = {
            ...
            "updated_at_epoch_ms": 1_786_713_540_000,
        }
