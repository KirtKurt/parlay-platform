  ...
  return (
    <main className="shell">
      ...
      <section className="hero-card glass-card" style={{ minHeight: 0, marginBottom: 20 }}>
        ...
        <h2>Welcome to Silvers Syndicate.</h2>
        <p className="hero-copy">This success state is ready for Stripe webhook confirmation. In production, member access should activate only after the payment provider confirms the subscription.</p>
      ...
      <section className="status-row">
        <article className="status-card"><span>Subscription</span><strong>Active demo</strong><p>Production should read this from billing webhooks.</p></article>
        <article className="status-card"><span>Access</span><strong>Core</strong><p>Full sport boards and Top-8 parlay rankings.</p></article>
