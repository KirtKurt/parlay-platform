...
import { adminFeatureFlags, adminMembers, adminSeoPages, adminSlipReviews } from '@/lib/inqsi-admin-data';
  ...
  return (
    <main className="shell">
      ...
      <section className="hero-card glass-card" style={{ minHeight: 0, marginBottom: 20 }}>
        ...
        <p className="hero-copy">Owner-only view for members, score-card visibility, SEO operations, IndexNow, support notes, audit events, feature flags, and content settings.</p>
      </section>
      ...
      <section className="status-row" style={{ marginBottom: 20 }}>
        ...
        <article className="status-card"><span>Slip reviews</span><strong>{adminSlipReviews.length}</strong><p>Saved slips queued for visibility review.</p></article>
