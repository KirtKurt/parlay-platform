    ...
    <main className="shell">
      ...
      <section className="hero-card glass-card" style={{ minHeight: 0, marginBottom: 20 }}>
        ...
        <div className="hero-actions">
          <Link className="primary-button large" href="/register" style={{ textDecoration: 'none' }}>Unlock {sport.label}</Link>
      ...
      <section className="status-row">
        ...
        <article className="status-card"><span>Builds</span><strong>Members</strong><p>Rankings and parlay output are paid workflow only.</p></article>
      </section>
