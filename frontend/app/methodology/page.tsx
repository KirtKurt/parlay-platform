...
const sections = [
  ...
  ['Movement path', 'Repeated snapshots show whether a move is strengthening, stalling, or starting to fall apart.', 'nba'],
  ['Market support', 'A side is gaining market support. It still has to survive confirmation before we treat it seriously.', 'mlb'],
    ...
    <main className="shell">
      ...
      <section className="sport-hero-grid">
        <div className="hero-card glass-card" style={{ minHeight: 0 }}>
          <p className="eyebrow blue">How the board thinks · 5 days free</p>
      ...
      <ContentBlock
        ...
        body="A signal is only useful if you can understand why it is there. That is why the same language repeats across the product. When you see resistance, chaos, or a coin-flip marker, the point is not to sound technical. The point is to make the risk easier to read."
        items={[
