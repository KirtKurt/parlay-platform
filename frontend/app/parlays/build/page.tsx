  ...
  return (
    <main className="shell">
      ...
      <section className="hero-card glass-card" style={{ minHeight: 0, marginBottom: 20 }}>
        <p className="eyebrow blue">Human-gated builder</p>
        <h2>Choose games. Enforce anchors. Refuse unsafe structures.</h2>
        <p className="hero-copy">This page will become the paid workflow: sport selection, number of legs, zero-overlap mode, risk tolerance, eligible games, Top-8 combinations, and reason-coded refusals.</p>
      </section>
