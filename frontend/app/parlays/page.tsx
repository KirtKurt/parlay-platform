  ...
  return (
    <main className="shell">
      ...
      <section className="hero-card glass-card" style={{ minHeight: 0, marginBottom: 20 }}>
        ...
        <h2>Build a smarter slip before you lock it in.</h2>
        <p className="hero-copy">Choose the games you like and let InQsi challenge the structure. The builder looks for strong anchors, spots coin-flip legs, checks overlap, and warns you when the market is not giving the slip enough support.</p>
        ...
        <div className="panel">
          <div className="panel-header">
            <div>
              ...
              <h3>How InQsi ranks the slip</h3>
            </div>
          </div>
